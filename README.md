...
你好！我是崔继轩。本仓库展示了我在简历中提到的核心 AI 算法落地项目的可视化效果与演示。

---

## 1. 基于联邦学习的分布式多模态基座模型微调平台（通用联邦学习平台）
> **关键词：** 云边协同 | INT8+LoRA | SFL 分割联邦 | 全链路监控
...
*图 3：引入聚类引导 CDDPM 扩充少数类样本后，最优模型（CatBoost）准确率达 96.0%*
...
> **关键词：** RsLoRA | 抗高频噪声 | 重参数化 | ONNX 老旧工控机部署
